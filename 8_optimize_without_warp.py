...
if __name__ == "__main__":
    ...
    # Save texture
    write_bitmap(output_dir+"warped_texture_200.png", warped, (600, 600))
    time.sleep(0.1)
    
    myapp.emit_image_update(output_dir+"warped_texture_200.png")
    time.sleep(0.1)
    #############################################
    ...
    for it in range(200, 501):
        ...
        # Save texture
        write_bitmap(output_dir+"warped_texture_%03i.png" % it, params['Projector.irradiance.data'], (600, 600))
        time.sleep(0.1)

        # Project warped image
        myapp.emit_image_update(output_dir+"warped_texture_%03i.png" % it)
        time.sleep(0.1)
